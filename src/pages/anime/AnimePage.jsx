  ...
  return (
    <>
      {isLoading ? (
        ...
        <>
          <div className=" relative w-[90%] md:w-[60%] mx-auto text-gray-800 p-3">
            {pictures && (
              <div
          ...
          <div className="w-[90%] md:w-[60%] mx-auto text-gray-200 p-3">
            ...
            <div className="tabs tabs-lift">
              ...
              <div className="tab-content bg-base-100 border-base-300 p-6 animate-fadeIn">
                {characters?.map((character) => character.character.name + " ")}
              </div>
